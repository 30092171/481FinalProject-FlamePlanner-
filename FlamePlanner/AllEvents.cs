...
namespace FlamePlanner
{
    ...
    public static class AllEvents
    {
        ...
        public static EventObject Stampede = new EventObject()
            .SetEventName("Calgary Stampede Highlight Party")
            .SetImage(new Uri("CalgaryStampedeEvent.jpg", UriKind.Relative))
            .SetEventDetails("At the heart of the Calgary Stampede, you’ll find more than 2,500 dedicated volunteers. They embody western values by hosting events across the city, supporting community celebrations and making the Calgary Stampede The Greatest Outdoor Show on Earth. In addition, the Board of Directors are unpaid volunteers who contribute their time to govern the affairs of the Calgary Stampede. This event session is a party for all those hard workers, Calgarians, and Tourists Alike. Food will be served and highlights from the 2021 stampede will be shown and celebrated.")
            .SetLocation("Stampede Grounds (1410 Olympic Way SE, Calgary, AB T2G 2W1)")
            .SetStartDate(new DateTime(2021, 9, 17))
        ...
        public static EventObject GlassFusion = new EventObject()
            ...
            .SetStartDate(new DateTime(2021, 10, 02))
            .SetStartTime(1200)
            .SetEndTime(1400)
